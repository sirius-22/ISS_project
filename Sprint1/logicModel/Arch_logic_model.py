...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     sonar_mock >> Edge( label='containerhere', **eventedgeattr, decorate='true', fontcolor='red') >> sys
     sonar_mock >> Edge( label='stopActions', **eventedgeattr, decorate='true', fontcolor='red') >> sys
     sonar_mock >> Edge( label='resumeActions', **eventedgeattr, decorate='true', fontcolor='red') >> sys
