		...
		return { //this:ActionBasciFsm
				...
				state("work1") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t046",targetState="work2",cond=whenReply("loadaccepted"))
					transition(edgeName="t047",targetState="work2",cond=whenReply("loadrejected"))
				}	 
				state("work2") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t048",targetState="work3",cond=whenReply("loadaccepted"))
					transition(edgeName="t049",targetState="work3",cond=whenReply("loadrejected"))
				}	 
				state("work3") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t050",targetState="work4",cond=whenReply("loadaccepted"))
					transition(edgeName="t051",targetState="work4",cond=whenReply("loadrejected"))
				}	 
