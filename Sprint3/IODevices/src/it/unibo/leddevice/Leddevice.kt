	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				state("init") { //this:State
					action { //it:State
						CommUtils.outyellow("$name | led ready")
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
					sysaction { //it:State
					}	 	 
					 transition( edgeName="goto",targetState="ledoff_state", cond=doswitch() )
				}	 
				state("ledoff_state") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t03",targetState="ledon_state",cond=whenDispatch("ledon"))
				}	 
				state("ledon_state") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t04",targetState="ledoff_state",cond=whenDispatch("ledoff"))
				}	 
			}
		}
} 
