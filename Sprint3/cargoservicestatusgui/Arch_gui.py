...
with Diagram('guiArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     sys >> Edge( label='changed', **evattr, decorate='true', fontcolor='darkgreen') >> gui_state_observer
     gui_state_observer >> Edge(color='magenta', style='solid', decorate='true', label='<loadrequest<font color="darkgreen"> loadaccepted loadrejected</font> &nbsp; >',  fontcolor='magenta') >> cargoservice
     ...
     cargoservice >> Edge(color='blue', style='solid',  decorate='true', label='<changed &nbsp; >',  fontcolor='blue') >> gui_state_observer
diag
